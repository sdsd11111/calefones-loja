                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 sm:gap-12 lg:gap-16 mb-16 md:mb-20 text-center md:text-left">
                    ...
                    <div className="flex flex-col items-center md:items-start space-y-8">
                        ...
                        <p className="text-gray-400 leading-relaxed text-sm font-medium">
                            Calefones Loja - Expertos en asesoramiento, reparación, mantenimiento y venta. Más de 20 años liderando el soporte técnico en el sur del Ecuador.
                        </p>
                    ...
                    {/* Col 2: Navigation */}
                    <div>
                        <h4 className="text-xs uppercase tracking-[0.2em] mb-8 text-gray-500 font-heading">Explorar</h4>
                    ...
                    <div>
                        <h4 className="text-xs uppercase tracking-[0.2em] mb-6 sm:mb-8 text-gray-500 font-heading">Marcas Autorizadas</h4>
                    ...
                    <div>
                        <h4 className="text-xs uppercase tracking-[0.2em] mb-8 text-gray-500 font-heading">Atención Directa</h4>
                        <div className="space-y-6 flex flex-col items-center md:items-start">
                            <div className="flex flex-col items-center md:items-start space-y-3 text-sm">
                                <span className="text-gray-300 font-medium text-center md:text-left">Calle Olmedo entre Azuay y Mercadillo (Junto a Radio Centinela del Sur y San Sebastián), Loja, Ecuador.</span>
                            </div>
